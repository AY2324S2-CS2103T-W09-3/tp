...
with(this){return _c('p',[_v("In this example, Irfan Ibrahim was initially in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list, at "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(" 1.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. CulinaryContacts shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("API (Application Programming Interface)")]),_v(": An API is a set of rules and tools that enables different software applications to communicate and interact with each other.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a new reservation for the first person in the displayed person list")]),_v(" "),_c('p',[_v("a. Prerequisites: There is at least 1 person in the displayed person list. There are no existing reservations made by the first person on 17/04/2024 at 6.00pm.")]),_v(" "),_c('p',[_v("b. Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsv 1 d/2024-04-17 t/1800 p/8")]),_c('br'),_v("\nExpected: A new reservation is added to the reservation list. Name and phone number of the person, as well as date, time and number of people will be displayed in the reservation card.")])]),_v(" "),_c('li',[_c('p',[_v("Adding a duplicate reservation with the same date and time")]),_v(" "),_c('p',[_v("a. Prerequisites: There is at least 1 person in the displayed person list. There is an existing reservation made by the first person on 17/04/2024 at 6.00pm.")]),_v(" "),_c('p',[_v("b. Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsv 1 d/2024-04-17 t/1800")]),_v(" p/5"),_c('br'),_v("\nExpected: Result display shows error message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("This person has already made a reservation at this date and timing in the address book")]),_v(". No new reservation is added to the reservation list.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting the first reservation in the reservation list")]),_v(" "),_c('p',[_v("a. Prerequisites: There is at least 1 reservation in the reservation list.")]),_v(" "),_c('p',[_v("b. Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsvdel 1")]),_c('br'),_v("\nExpected: First reservation is deleted from the reservation list. Details of the reservation shown in the result display.")]),_v(" "),_c('p',[_v("c. Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsvdel 1000")]),_c('br'),_v("\nExpected: Result display shows error message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("The reservation index provided is invalid")]),_v(". No reservation is deleted from the reservation list.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Sorting all reservations")]),_v(" "),_c('p',[_v("a. Prerequisites: Multiple reservations in the reservation list. There is at least 1 non-expired reservation and 1 expired reservation in the reservation list. There is at least 1 person in the displayed person list.")]),_v(" "),_c('p',[_v("b. Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsv 1 d/2024-09-25 t/1800 p/4")]),_v(", followed by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsvsort")]),_c('br'),_v("\nExpected: The new reservation is added to the bottom of the reservation list. After the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rsvsort")]),_v(" command is called, the reservation list is now sorted in the "),_c('a',{attrs:{"href":"/tp/UserGuide.html#sorting-reservations-rsvsort"}},[_v("correct order")]),_v(".")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sun, 14 Apr 2024, 15:40:14 GMT+8]")])])])}
}];
