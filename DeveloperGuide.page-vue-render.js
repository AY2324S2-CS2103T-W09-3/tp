...
with(this){return _c('p',[_v("The implementation help command is more related to Ui part of the code compared to other commands as it opens another window to show the command summary of all commands. It is facilitated by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("handlehelp")]),_v(" method in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow")]),_v(" class.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following activity diagram shows how a user view the help window with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")]),_v(" command.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")]),_v(" command to open the help window. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow#executeCommand()")]),_v(" will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainWindow#isShowHelp()")]),_v(" to check if the command to be executed is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")]),_v(" command. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")]),_v(" command is detected and causes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#handleHelp()")]),_v(" to be called which opens the help window.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user can copy the website address by clicking "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CopyURL")]),_v(" button on the help window and navigate to the program website for more detailed information.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 5. The user can then click the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("X")]),_v(" on top right corner or press"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Q")]),_v(" on keyboard to close the help window and return to the main window.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Adding a person: The contact will be immediately added into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("archivedPersons")]),_v(" list.")]),_v(" "),_c('li',[_v("Editing a person: The contact details of the person at the index specified inside the archived list will be edited.")]),_v(" "),_c('li',[_v("Finding persons by name: Only names inside the archived list matching the keyword(s) provided will be displayed in the list.")]),_v(" "),_c('li',[_v("Filtering persons by tag: Only contacts inside the archived list with tags matching all tags provided in the filter command will be displayed.")]),_v(" "),_c('li',[_v("Deleting a person: The contact inside the archived list at the index specified in the delete command will be deleted.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("small family restaurant owners")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts such as suppliers, employees and customers")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new person.")])]),_v(" "),_c('li',[_c('p',[_v("CulinaryContacts adds the new person to the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - List all persons")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to show all contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("CulinaryContacts shows all persons in the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to "),_c('u',[_v("list all persons (UC03)")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit the fields of a specific person in the list.")])]),_v(" "),_c('li',[_c('p',[_v("CulinaryContacts edits the fields of the person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. CulinaryContacts shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The new field value(s) is/are invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. CulinaryContacts shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("2c. No fields to edit are provided.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. CulinaryContacts shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find all persons with names matching the input keyword(s).")])]),_v(" "),_c('li',[_c('p',[_v("CulinaryContacts shows all persons with matching names.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find all persons with specific tag(s).")])]),_v(" "),_c('li',[_c('p',[_v("CulinaryContacts shows all persons with a matching tag.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to "),_c('u',[_v("list all persons (UC03)")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list.")])]),_v(" "),_c('li',[_c('p',[_v("CulinaryContacts deletes the person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Use an ID field as the unique identifier")]),_v(": The current unique identifier is the name of the person preventing addition of duplicate names. This is too restrictive as persons with the same name are quite common in reality. The user may also want to only record the first or last name which may cause more duplicate names. We plan to use the person's ID field as a unique identifier, which will allow duplicate names to be recorded.")]),_v(" "),_c('li',[_c('strong',[_v("Sync contact updates with reservation")]),_v(": Currently, when a user edits a contact's name or phone number in the contacts list, these changes are not reflected in existing reservations made for that contact. As a result, the reservation records become inconsistent with the updated contact details. We plan to enhance this feature by ensuring that any updates to a contact in the contacts or archived list will automatically update the contact's details in the reservation list. For example, if the contact John Doe's phone number is updated, all existing reservations under John Doe's name will automatically reflect this new phone number.")]),_v(" "),_c('li',[_c('strong',[_v("Cascading reservation deletion")]),_v(": Currently, when a contact is deleted, their existing reservations remain in the address book. However, this process can be cumbersome for users, as they must manually delete each reservation individually. To enhance user-friendliness, we plan to implement cascading deletion, whereby deleting a contact will also remove all associated reservations automatically.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sat, 13 Apr 2024, 22:14:31 GMT+8]")])])])}
}];
