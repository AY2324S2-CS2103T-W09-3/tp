...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical\nusage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin\ncommands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("New users should be able to perform basic operations (add, edit, list, delete contacts) with some\nguidance from the help documentation.")]),_v(" "),_c('li',[_v("The product is not required to handle financial or inventory aspects of managing a restaurant.")]),_v(" "),_c('li',[_v("All text must be at least font size 12 to ensure readability.")]),_v(" "),_c('li',[_v("Comprehensive documentation, including user guides and developer guides should be updated with each\nrelease.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Wed, 13 Mar 2024, 18:39:40 GMT+8]")])])])}
}];
