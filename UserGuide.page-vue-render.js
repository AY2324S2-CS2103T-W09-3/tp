...
with(this){return _c('ul',[_c('li',[_v("The fields "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ADDRESS")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")]),_v(" on the contact card will be truncated if\nthey are too long, to maintain neatness. The character limit before truncation is sufficient for most inputs so normal usage is not hindered.")]),_v(" "),_c('li',[_v("The 'supplier' tag is green.")]),_v(" "),_c('li',[_v("The 'employee' tag is blue.")]),_v(" "),_c('li',[_v("The 'customer' tag is yellow.")]),_v(" "),_c('li',[_v("All other tags are white.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The person's "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(" and reservation's "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PAX")]),_v(" on the reservation card will be truncated if they are too long, with\nthe same reason as above.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Deletes the reservation at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(".")]),_v(" "),_c('li',[_v("The index refers to the index number shown in the reservation list.")]),_v(" "),_c('li',[_v("The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")])])}
},function anonymous(
) {
